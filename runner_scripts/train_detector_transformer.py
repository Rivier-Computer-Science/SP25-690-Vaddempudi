...
train_reps = torch.load('saved_results/transformer_train_reps.pth').to(device)
test_reps = torch.load('saved_results/transformer_train_reps.pth').to(device)
...
torch.save(model.state_dict(), 'saved_results/transformer_detector.pth')
print("Transformer based detector trained.")
